...
from src.core.models import SearchQueryGeneration, AssistantPersona
from src.prompts import get_search_queries_prompt
...
def generate_search_queries(
    ...
    logger.info(f"Generating {num_queries} search queries for: '{user_question[:100]}...'")
